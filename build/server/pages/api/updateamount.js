  ...
  if (req.method === 'PUT') {
    try {
      ...
      if (newAmount < 0) {
        ...
        const updateAmountInfo = await _models_shopGoods__WEBPACK_IMPORTED_MODULE_2__/* ["default"].findByIdAndUpdate */ .Z.findByIdAndUpdate(id, {
...
var __webpack_exports__ = __webpack_require__.X(0, [4903], () => (__webpack_exec__(390)));
