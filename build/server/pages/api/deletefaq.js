...
async function handler(req, res) {
  ...
  if (req.method === 'DELETE') {
    try {
      const id = req.body;
      await _models_shopFaq__WEBPACK_IMPORTED_MODULE_3__/* ["default"].deleteOne */ .Z.deleteOne({
        _id: id
      });
      res.send({
...
var __webpack_exports__ = __webpack_require__.X(0, [4903], () => (__webpack_exec__(2287)));
