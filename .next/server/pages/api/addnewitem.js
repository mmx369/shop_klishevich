...
module.exports = __webpack_require__("QnHW");
...
const handler = async (req, res) => {
  ...
  if (req.method === 'POST') {
    try {
      ...
      const findItem = await _models_shopGoods__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].findOne({
      ...
      const newItem = new _models_shopGoods__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]({
        nameOfGoods,
        amountOfGoods,
        priceOfGoods,
        catalogNumber,
