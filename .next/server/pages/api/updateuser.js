...
module.exports = __webpack_require__("Yi1V");
...
/* harmony import */ var _models_shopUser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("X5z3");
/* harmony import */ var _db_connectDb__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("Pyq8");
  ...
  if (req.method === 'PUT') {
    try {
      ...
      if (!name && !role && !email) {
        ...
        const updateUserInfo = await _models_shopUser__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].findByIdAndUpdate(id, {
          email
        }, {
          new: true
        });
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_db_connectDb__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(handler));
