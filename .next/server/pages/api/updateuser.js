  ...
  if (req.method === 'PUT') {
    try {
      ...
      if (!name && !role && !email) {
        ...
        const updateUserInfo = await _models_shopUser__WEBPACK_IMPORTED_MODULE_1__/* .default.findByIdAndUpdate */ .Z.findByIdAndUpdate(id, {
          email
        }, {
          new: true
        });
...
var __webpack_exports__ = (__webpack_exec__(3282));
