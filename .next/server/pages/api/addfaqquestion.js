...
module.exports = __webpack_require__("zZAZ");
...
/* harmony import */ var _models_shopFaq__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("EZfW");
...
const handler = async (req, res) => {
  ...
  if (req.method === 'POST') {
    try {
      ...
      const newFaq = new _models_shopFaq__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]({
        answer,
        question,
        date: new Date()
      });
