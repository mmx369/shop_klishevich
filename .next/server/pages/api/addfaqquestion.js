...
/* harmony import */ var _models_shopFaq__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8302);
...
const handler = async (req, res) => {
  ...
  if (req.method === 'POST') {
    try {
      ...
      const newFaq = new _models_shopFaq__WEBPACK_IMPORTED_MODULE_0__/* .default */ .Z({
        answer,
        question,
        date: new Date()
      });
...
var __webpack_exports__ = (__webpack_exec__(5172));
